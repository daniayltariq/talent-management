...
-- Dumping data for table talent.community: ~0 rows (approximately)
...
-- Dumping data for table talent.experience: 7 rows
...
-- Dumping data for table talent.model_has_roles: ~2 rows (approximately)
...
-- Dumping data for table talent.profile: ~3 rows (approximately)
...
INSERT INTO `profile` (`id`, `user_id`, `legal_first_name`, `legal_last_name`, `email`, `height`, `feet`, `weight`, `eyes`, `hairs`, `neck`, `waist`, `sleves`, `chest`, `shoes`, `address_1`, `address_2`, `zip`, `country`, `state`, `city`, `telephone`, `mobile`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 4, 'Cynthia', 'Jackson', 'cynthia@gmail.com', '5\'7\'\'', 9, NULL, 'brown', 'brown', '15', '17', '15', '22', '9', 'test address', NULL, '078690', 'New Jearsey', NULL, NULL, NULL, NULL, '2020-11-04 15:27:16', '2020-11-04 15:27:16', '2020-11-16 17:25:57'),
	(2, 4, 'Jawad', 'Ahmed', 'jawadahmed1024@gmail.com', '4', 1, 40, 'brown', 'black', '2', '2', '2', '22', '8', 'test address 542,52, test adderess, test adderess', 'test adderess', '46000', 'Pakistan', 'Punjab', 'rwp', '6092922121', '6092922121', '2020-11-16 13:17:02', '2020-11-16 13:38:27', NULL);
...
-- Dumping data for table talent.subscriptions: 1 rows
...
-- Dumping data for table talent.subscription_items: 1 rows
...
-- Dumping data for table talent.topics: ~0 rows (approximately)
...
-- Dumping data for table talent.users: ~3 rows (approximately)
...
INSERT INTO `users` (`id`, `f_name`, `l_name`, `gender`, `dob`, `phone`, `email`, `email_verified_at`, `email_verification_code`, `password`, `country`, `city`, `state`, `h_adress_1`, `h_adress_2`, `zipcode`, `remember_token`, `created_at`, `updated_at`, `stripe_id`, `card_brand`, `card_last_four`, `trial_ends_at`) VALUES
	(1, 'super', 'admin', 'male', '2222-12-06', '123', 'admin@talent.com', '2020-09-16 18:12:08', NULL, '$2y$10$YrgReU37ymwLGQqXGz5xAeVaWZhth950e5Mj4BBoL/2rg85ro5f2K', 'asd', 'asd', 'AK', 'asd', 'asd', '231', NULL, '2020-09-16 13:33:20', '2020-09-16 18:12:08', NULL, NULL, NULL, NULL),
	(2, 'AWAIS', 'AWAISS', 'male', '2020-09-06', '123', 'agent@talent.com', '2020-09-16 18:03:01', NULL, '$2y$10$YrgReU37ymwLGQqXGz5xAeVaWZhth950e5Mj4BBoL/2rg85ro5f2K', 'asd', 'asd', 'AK', 'asd', 'asd', '123', NULL, '2020-09-16 18:02:09', '2020-09-16 18:03:01', NULL, NULL, NULL, NULL),
	(4, 'ali', 'khan', 'male', '1996-03-06', '6092922121', 'user@talent.com', NULL, NULL, '$2y$10$YrgReU37ymwLGQqXGz5xAeVaWZhth950e5Mj4BBoL/2rg85ro5f2K', 'United States', 'NJ', 'AK', 'bdhbw akbwjd', 'test adderess', '07097', NULL, '2020-11-02 09:08:19', '2020-11-03 14:41:51', 'cus_IK4reNt4t7NIuH', 'visa', '4242', NULL);
