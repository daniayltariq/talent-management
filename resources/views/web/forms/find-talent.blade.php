                            ...
                            @foreach ($members as $member)
                                <div class="effect-bubba grid-item grid-item__width2 new-faces women" style="height: 530px;" data-category="women">
                                    ...
                                    <div class="grid-item__contant-info">
                                        <div class="grid-item__contant-name">{{$member->profile()->exists() ? ($member->profile->legal_first_name.' '.$member->profile->legal_last_name) : ($member->f_name.' '.$member->l_name)}} </div>
