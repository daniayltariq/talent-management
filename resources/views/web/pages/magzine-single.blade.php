		...
		<div class="container">
			<div class="row">
				<div class="post-single col-md-7">
					<article class="post-single__content">
						<div class="post__thumbnail">
							<img src={{asset("img/single-post.jpg")}} alt="">
						</div>
					...
					<nav class="post__navigation">
					  <div class="nav-links row">
				  		<figure class="nav-links__previous col-sm-6">
							<span class="pull-left"><a href="#"><img src="img/nav-prev.jpg" alt=""></a></span>
						...
						<figure class="nav-links__next col-sm-6">
							<span class="pull-right"><a href="#"><img src="img/nav-next.jpg" alt=""></a></span>
							<figcaption class="widget-latest__content">
					...
					<div class="comments">
   						...
   						<ol class="comment-list">
   							<li class="comment-list__item">
   								...
   								<ol class="comment-list children">
   									<li class="comment-list__item">
   										<div class="comment__body">
			   								<div class="comment__avatar">
			   									<img src={{asset("/img/testimonal-photo.png")}} alt="">
			   								</div>
			   								<div class="comment__info">
   									...
   									<li class="comment-list__item">
   										<div class="comment__body">
			   								<div class="comment__avatar">
			   									<img src={{asset("/img/testimonal-photo2.png")}} alt="">
			   								</div>
			   								<div class="comment__info">
   							...
   							<li class="comment-list__item">
   								<div class="comment__body">
	   								<div class="comment__avatar">
	   									<img src={{asset("/img/testimonal-photo3.png")}} alt="">
	   								</div>
	   								<div class="comment__info">
				...
				<aside class="blog__sidebar col-md-4 col-md-offset-1">
					...
					<div class="sidebar-widget">
						<h4 class="widget__title">MORE FROM COVER STORIES</h4>
						<div class="widget__latest">
							<figure class="widget-latest__post">
								<span class="pull-left"><a href="#"><img src={{asset("/img/jessica-alba-campari-bts-56.jpg")}} alt=""></a></span>
								<figcaption class="widget-latest__content">
							...
							<figure class="widget-latest__post">
								<span class="pull-left"><a href="#"><img src={{asset("/img/jessica-alba-campari-bts-45.jpg")}} alt=""></a></span>
								<figcaption class="widget-latest__content">
							...
							<figure class="widget-latest__post">
								<span class="pull-left"><a href="#"><img src={{asset("/img/jessica-alba-campari-bts-34.jpg")}} alt=""></a></span>
								<figcaption class="widget-latest__content">
									<a href="#" class="widget-latest__title">Easy Home Remedy For</a>
									<p class="widget-latest__date">16 Oct 2016</p>
								</figcaption>
							...
							<figure class="widget-latest__post">
								<span class="pull-left"><a href="#"><img src={{asset("/img/jessica-alba-campari-bts-57.jpg")}} alt=""></a></span>
								<figcaption class="widget-latest__content">
									<a href="#" class="widget-latest__title">Does Hydroderm Work</a>
					...
					<div class="sidebar-widget">
						<h4 class="widget__title">Now Trending </h4>
						<div class="widget__latest">
							<figure class="widget-latest__post">
								<span class="pull-left"><a href="#"><img src={{asset("/img/jessica-alba-campari-bts-56.jpg")}} alt=""></a></span>
								<figcaption class="widget-latest__content">
