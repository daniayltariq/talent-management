			...
			<div class="row">
				<div class="blog__posts col-md-7">
					<div class="blog__list">
							...
							<a href=""><h4 class="widget__title pull-right widget__titless" >Browse conversations from all topics </h4></a>	
						...
						<article class="blog__post">
							...
							<p class="widget-latest__date">RECENT CONVERSATIONS</p>
							<a href=""><h4 class="widget__title height_line" >Free Acting Lessons</h4> </a>
						...
						<article class="blog__post">
							...
							<div class="post__content">
								<a href="single-post.html"><h3 class="post__title">The Working Actor
</h3></a>
							</div>
							<p class="widget-latest__date">RECENT CONVERSATIONS</p>
							<a href=""><h4 class="widget__title height_line" >Free Acting Lessons</h4> </a>
