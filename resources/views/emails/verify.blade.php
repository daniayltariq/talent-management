        ...
        <tr>
          <td valign="top" class="bg_white" style="padding: 1em 2.5em;">
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td>
                  <p style="margin-left: 1.7rem">Please click the button below to verify your email address.</p>
                </td>
              </tr>
              <tr>
                <td>
                  <p style="text-align: center"><a href="{{$url}}" class="btn btn-fltyel" target="_blank">Verify Email Address</a></p>
                </td>
              </tr>
            </table>
          </td>
