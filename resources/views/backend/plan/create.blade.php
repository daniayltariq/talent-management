                  ...
                  <form action="{{$route}}" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                     ...
                     <div class="d-flex mb-3">
                        <div class="col-md-4">
                           ...
                           <input type="number" required="required" min="1" name="pictures" value="{{$plan->pictures ?? ''}}" class="form-control col-md-12 col-xs-12">
                        </div>
                        <div class="col-md-4">
                           <label class="control-label " >Audios<span class="required">*</span>
                           </label>
                           <input type="number" required="required" min="1" name="audios" value="{{$plan->audios ?? ''}}" class="form-control col-md-12 col-xs-12">
                        </div>
                        <div class="col-md-4">
                           <label class="control-label " >Videos<span class="required">*</span>
                           </label>
                           <input type="number" required="required" min="1" name="videos" value="{{$plan->videos ?? ''}}" class="form-control col-md-12 col-xs-12">
                        </div>
